...
$$ LANGUAGE plpgsql volatile;
 ...
 deployid              | integer               | v1
 platform_id           | integer               | v2 int
 program_id            | integer               | v3 int
 latitude              | double precision      | v4
 longitude             | double precision      | v5
 location_quality      | character varying(4)  | v6
 location_date         | character varying(32) | v7
 location_type         | character varying(16) | v8
 altitude              | integer               | v9
 data_pass             | integer               | v10 int
 satellite             | character varying(8)  | v11
 mote_id               | character varying(32) | v12
 frequency             | double precision      | v13 double
 message_date          | character varying(32) | v14
 comp                  | integer               | v15 int
 message               | character varying(32) | v16 int
 greater_120db         | character varying(32) | v17
 best_level            | double precision      | v18
 delta_frequency       | double precision      | v19 double
 longitude1            | double precision      | v20
 latitude_sol1         | double precision      | v21
 longitude2            | double precision      | v22
 latitude_sol2         | double precision      | v23
 location_index        | integer               | v24
 nopc                  | integer               | v25
 error_radius          | integer               | v26
 error_semi_major_axis | integer               | v27
 error_semi_minor_axis | integer               | v28
 error_ellipse_orient  | integer               | v29
 gdop                  | integer               | v30
 data_sensor           | integer[]             | v31-62
