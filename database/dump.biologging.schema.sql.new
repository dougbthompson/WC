...
--
-- Name: tmp_all_deployment_profiles; Type: TABLE; Schema: biologging; Owner: dougt
--
...
ALTER TABLE tmp_all_deployment_profiles OWNER TO dougt;

--
-- Name: tmp_all_deployments; Type: TABLE; Schema: biologging; Owner: dougt
--
...
ALTER TABLE tmp_all_deployments OWNER TO dougt;

--
-- Name: tmp_all_locations; Type: TABLE; Schema: biologging; Owner: dougt
--
...
ALTER TABLE tmp_all_locations OWNER TO dougt;

--
-- Name: tmp_all_profiles; Type: TABLE; Schema: biologging; Owner: dougt
--
...
ALTER TABLE tmp_all_profiles OWNER TO dougt;
