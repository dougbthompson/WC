...
namespace Drupal\entity_atn_organization\Entity;

use Drupal\Core\Entity\EntityStorageInterface;
use Drupal\Core\Field\BaseFieldDefinition;
use Drupal\Core\Entity\ContentEntityBase;
use Drupal\Core\Entity\EntityTypeInterface;
use Drupal\entity_atn_organization\OrganizationInterface;
use Drupal\organization\OrganizationInterface;
 ...
 *
 * @ContentEntityType(
 *   id = "entity_atn_organization_organization",
 *   label = @Translation("Organization entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\entity_atn_organization\Entity\Controller\OrganizationListBuilder",
 *     "form" = {
 *       "add" = "Drupal\entity_atn_organization\Form\OrganizationForm",
 *       "edit" = "Drupal\entity_atn_organization\Form\OrganizationForm",
 *       "delete" = "Drupal\entity_atn_organization\Form\OrganizationDeleteForm",
 *     },
 *     "access" = "Drupal\entity_atn_organization\OrganizationAccessControlHandler",
 *   },
 *   list_cache_contexts = { "organization" },
 *   base_table = "atn_organization",
 *   admin_permission = "administer entity_atn_organization entity",
 *   entity_keys = {
 *     "id"    = "id",
 *     "label" = "organization_name"
 *   },
 *   links = {
 *     "canonical" = "/entity_atn_organization_organization/{entity_atn_organization_organization}",
 *     "edit-form" = "/entity_atn_organization_organization/{entity_atn_organization_organization}/edit",
 *     "delete-form" = "/organization/{entity_atn_organization_organization}/delete",
 *     "collection" = "/entity_atn_organization_organization/list"
 *   },
 *   field_ui_base_route = "entity_atn_organization.organization_settings",
 * )
 *
 ...
 * Example: 'entity.entity_atn_organization_organization.canonical'
 *
...
class Organization extends ContentEntityBase implements OrganizationInterface {
   ...
   * {@inheritdoc}
   *
   * When a new entity instance is added, set the organization_id entity reference to
   * the current organization as the creator of the instance.
   */
  public static function preCreate(EntityStorageInterface $storage_controller, array &$values) {
    parent::preCreate($storage_controller, $values);
    $values += [
      'organization_id' => \Drupal::currentOrganization()->id(),
    ];
  }
  ...
  public function getOwner() {
    return $this->get('organization_id')->entity;
  }
  ...
  public function getOwnerId() {
    return $this->get('organization_id')->target_id;
  }
   ...
   * {@inheritdoc}
   */
  public function setOwner(OrganizationInterface $account) {
    $this->set('organization_id', $account->id());
    return $this;
  }
